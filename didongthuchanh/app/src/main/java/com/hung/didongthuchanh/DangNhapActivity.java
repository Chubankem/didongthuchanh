    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        google_signIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent= new Intent(DangNhapActivity.this, com.hung.didongthuchanh.GoogleSignInActivity.class);
        ...
        tv1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent= new Intent(DangNhapActivity.this, com.hung.didongthuchanh.SignUpActivity.class);
                startActivity(intent);
            }
        });
    }
            ...
            fAuth.signInWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if(task.isSuccessful()){
                        ...
                        Intent intent = new Intent(DangNhapActivity.this, com.hung.didongthuchanh.SignInActivity.class);
                        startActivity(intent);
                    }
                    else {
